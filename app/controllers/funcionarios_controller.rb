class FuncionariosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @funcionario.save
        format.html { redirect_to '/funcionarios', notice: 'Funcionario cadastrado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @funcionario.update(funcionario_params)
        format.html { redirect_to '/funcionarios', notice: 'Funcionario atualizado com sucesso.' }
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:nome, :endereco, :cidade, :estado, :cep, :telefone, :admissao, :cpf, :identidade, :data_nascimento, :cargo)
    end
end
